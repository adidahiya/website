...
/***/ (function(module, exports) {
	...
	module.exports = {"header":"src-layouts----index-module---header---2Yrp-","body":"src-layouts----index-module---body---32gfx"};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const TemplateWrapper = ({ children, location }) => {
	    ...
	    const childContentsWithHeader = React.createElement(React.Fragment, null, React.createElement(Header, null), React.createElement("div", { className: styles.body }, children()));
	    const redirectNotice = React.createElement("p", null, "Contents have moved... redirecting to root page");
	    return React.createElement(React.Fragment, null, React.createElement(react_helmet_1.default, { title: "Adi Dahiya", link: LINK_TAGS, meta: isLegacyRoute ? META_TAGS_WITH_REDIRECT : META_TAGS }), isLegacyRoute ? redirectNotice : childContentsWithHeader);
	};
...
//# sourceMappingURL=component---src-layouts-index-tsx-f27c9027edeff68c2a05.js.map