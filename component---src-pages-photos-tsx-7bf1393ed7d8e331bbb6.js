...
/***/ (function(module, exports) {
	...
	module.exports = {"photos":"src-pages----photos-module---photos---39-1_","linkNoDecoration":"src-pages----photos-module---linkNoDecoration---1LJJH"};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const FlickrImg = ({ href, src }) => React.createElement("a", { className: styles.linkNoDecoration, href: href }, React.createElement("img", { src: src }));
	const PhotosPage = () => React.createElement("div", { className: styles.photos }, React.createElement("h2", null, "selected photographs"), React.createElement("p", null, "I take photos for fun\u2014usually to capture & document beauty on my travels, but also sometimes simply as visual expression. ", React.createElement("br", null), " ", React.createElement("br", null), "See more on ", React.createElement("a", { href: "https://www.flickr.com/photos/adidas006" }, "flickr"), " \u2192"), React.createElement("h3", null, "abstract"), React.createElement("p", null, [{
	...
	}].map((p, key) => React.createElement(FlickrImg, Object.assign({}, p, { key: key })))), React.createElement("h3", null, "landscapes, nature"), React.createElement("p", null, [{
	...
	}].map((p, key) => React.createElement(FlickrImg, Object.assign({}, p, { key: key })))), React.createElement("h3", null, "people"), React.createElement("p", null, [{
	...
	}].map((p, key) => React.createElement(FlickrImg, Object.assign({}, p, { key: key })))));
	exports.default = PhotosPage;

/***/ })

});
//# sourceMappingURL=component---src-pages-photos-tsx-7bf1393ed7d8e331bbb6.js.map