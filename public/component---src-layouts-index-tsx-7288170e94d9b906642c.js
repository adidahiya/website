...
/***/ (function(module, exports, __webpack_require__) {
	...
	const META_ATTRIBUTES = [{ name: "description", content: "Sample" }, { name: "keywords", content: "sample, something" }];
	const TemplateWrapper = ({ children }) => React.createElement("div", null, React.createElement(react_helmet_1.default, { base: { href: "/public" }, title: "Adi Dahiya", meta: META_ATTRIBUTES }), React.createElement(Header, null), React.createElement("div", { className: styles.body }, children()));
...
//# sourceMappingURL=component---src-layouts-index-tsx-7288170e94d9b906642c.js.map